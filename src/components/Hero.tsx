    ...
    >
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
        <div className="animate-fade-in space-y-8 pt-16 sm:pt-20 md:pt-24">
          <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-[3.25rem] font-bold text-zenblock-inverse-text mb-6 leading-[1.35] sm:leading-[1.625]">
            <span className="flex flex-col space-y-6">
              <span>Enabling Trust in</span>
              <span className="bg-gradient-to-r from-zenblock-white to-zenblock-electric-blue bg-clip-text text-transparent leading-[1.6]">
                {/* Added leading-[1.6] specifically here */}
          ...
          <p className="text-sm sm:text-base md:text-lg lg:text-[1.25rem] text-zenblock-inverse-text/90 mb-8 max-w-3xl mx-auto leading-relaxed px-2 sm:px-0">
            Zenblock Labs provides end-to-end traceability solutions for
            pharmaceutical supply chains, ensuring regulatory compliance and
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 max-w-3xl mx-auto px-4 sm:px-0">
            <div className="text-center">
              <div className="text-xl md:text-2xl lg:text-[1.5rem] font-bold text-zenblock-white mb-2">
                100%
              </div>
              <div className="text-zenblock-inverse-text/80 text-sm lg:text-[0.875rem]">
                Drug Traceability
              </div>
            </div>
            <div className="text-center">
